 ...
 */
require_once ROCKON_PATH_SERVER_PATH .'/theme_plugin/rockon-class-tgm-plugin-activation.php';
add_action( 'tgmpa_register', 'rockon_register_required_plugins' );
 ...
 */
function rockon_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
            'name'               => 'rockoncore', // The plugin name.
            'slug'               => 'rockoncore', 
            'source'             => get_stylesheet_directory() . '/theme_plugin/rockoncore.zip', // The plugin source.
		...
		array(
            ...
            'source'             => get_stylesheet_directory() . '/theme_plugin/js_composer.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
		 ...
		 array(
            'name'               => 'revslider Plugin', // The plugin name.
            'slug'               => 'revslider', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/theme_plugin/revslider.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
		...
		array(
            'name'               => 'soundcloud is gold', // The plugin name.
            'slug'               => 'soundcloud-is-gold', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/theme_plugin/soundcloud-is-gold.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
